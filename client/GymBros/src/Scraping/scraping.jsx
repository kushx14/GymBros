  ...
  return (
    <div>
          ...
          <div className="flex h-screen bg-black">
            ...
            {/* Main content */}
            <div className="flex flex-col flex-1 overflow-y-auto pt-6 text-gray-50">
            <h1>Popular Exercises</h1>
              <ul>
                {Object.entries(data.popularexercises).map(([exercise, percentage]) => (
                  <li key={exercise}>{exercise}: {percentage}</li>
                ))}
              </ul>

              <h1>Industry Stats</h1>
              <ul>
                {data.industrystats.map((stat, index) => (
