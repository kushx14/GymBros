            ...
            <nav className="z-10 sticky top-0 left-0 right-0 max-w-3xl xl:max-w-[75%] mx-auto px-5 py-1.5 lg:border-none lg:py-2">
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden lg:flex lg:items-center gap-x-2 ml-6">
                        <Link to="/signin">
                            <button className="flex items-center justify-center rounded-xl bg-[#eb5e28] text-white px-4 py-1.5 font-semibold hover:shadow-lg hover:drop-shadow transition duration-200">
                                Sign up
                            </button>
                        </Link>
                        <Link to="/login">
                            <button className="flex items-center justify-center rounded-xl bg-black text-white border border-white px-6 py-1.5 font-semibold hover:shadow-lg hover:drop-shadow transition duration-200">
                                Login
                            </button>
                        </Link>
                    </div>
